# 🧩 **Kubernetes Pods — Questions & Answers**
...
### ❓3. Which image is specified for the pods whose names begin with the **newpods-** prefix?
...
### ❓5. We just created a pod named **webapp**. How many containers are part of the webapp pod?
...
**🅰️ Answer:**
Check the container’s status using:
...
### ❓8. Why do you think the container **agentx** in the pod is in error?
...
* `1/1` → One container is running and ready.
...
✅ This deletes the pod immediately from the cluster.

---

### ❓11. Create a new pod with the name **redis** and image **redis123**.
...
### ❓12. Change the image on the **redis** pod from `redis123` to `redis`.

**🅰️ Answer:**
You **cannot directly edit a running pod’s image**.
